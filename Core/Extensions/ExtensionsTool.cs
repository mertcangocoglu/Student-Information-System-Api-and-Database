...
namespace Core.Extensions
{
    public static class ExtensionsTool
    {
        ...
        /// <summary>
        /// long null değil ise true döner.
        /// </summary>
        /// <param name="item"></param>
        /// <returns></returns>
        public static bool IsNotNull(this long? item) => item is not null;
        ...
        /// <param name="item"></param>
        /// <returns></returns>
        public static bool IsNotDefault(this bool? item) => item is not default(bool);
        ...
        /// <param name="item"></param>
        /// <returns></returns>
        public static bool IsNotDefault(this long? item) => item is not default(long);
